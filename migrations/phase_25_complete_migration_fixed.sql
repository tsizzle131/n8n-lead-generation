-- ============================================================================
-- PHASE 2.5 COMPLETE MIGRATION: LinkedIn + Bouncer Integration (FIXED)
-- ============================================================================
...
BEGIN
    IF NOT EXISTS (
        ...
        AND column_name = 'linkedin_enriched'
    ) THEN
        ALTER TABLE gmaps_businesses ADD COLUMN linkedin_enriched BOOLEAN DEFAULT FALSE;
    END IF;
END $$;
...
DROP TRIGGER IF EXISTS update_gmaps_linkedin_enrichments_updated_at
...
DROP POLICY IF EXISTS "Allow authenticated read access" ON gmaps_linkedin_enrichments;
DROP POLICY IF EXISTS "Allow authenticated insert access" ON gmaps_linkedin_enrichments;
DROP POLICY IF EXISTS "Allow authenticated update access" ON gmaps_linkedin_enrichments;
DROP POLICY IF EXISTS "Allow anon read access" ON gmaps_linkedin_enrichments;
DROP POLICY IF EXISTS "Allow anon insert access" ON gmaps_linkedin_enrichments;
DROP POLICY IF EXISTS "Allow anon update access" ON gmaps_linkedin_enrichments;
